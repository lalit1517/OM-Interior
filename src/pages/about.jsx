...
const About = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>About Us - OM INTERIOR</title>
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="About Us - Om Interior | OM Interior is a growing architecture, interior design, and civil engineering firm in India..."
        />
