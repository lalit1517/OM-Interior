...
const ConstructionMng = () => {
  return (
    <div>
      <Helmet>
        <title>Service - Construction Management</title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://ominterior.ind.in/construction-management"
        />
          ...
          <div className="container my-3">
            <div className="row">
              <div className="col-md-12 align-self-center p-static order-2 text-center">
                <h1 className="font-bold text-10 text-white">Service</h1>
              </div>
            ...
            <div className="row">
              <div className="col-md-8">
                <div className="service_details_left">
                  <img
                    src="construction-solution.png"
                    alt="Service Details - Construction Management"
                  />
                  <h1 className="text-gray-800">Construction Management</h1>
                  <p className="text-gray-400">
                  Ensure the successful execution of your project with our dedicated construction management services. From pre-planning feasibility to on-site management, our team oversees every aspect to guarantee a smooth and efficient construction process.
                  </p>
                  <ul className="text-gray-400 pl-0">
                    <li className="text-gray-400">
                      <i className="fa fa-check-circle"></i> Feasibility Analysis: Thorough assessment to ensure the viability of the construction plan.
                    </li>
                    <li className="text-gray-400">
                      <i className="fa fa-check-circle"></i> Timeline Coordination: Efficient scheduling and coordination to meet project milestones.
                    </li>
                    <li className="text-gray-400">
                      <i className="fa fa-check-circle"></i> Risk Mitigation: Proactive identification and management of potential project risks.
                    </li>
                    <li className="text-gray-400">
                      <i className="fa fa-check-circle"></i> Resource Optimization: Ensuring the efficient use of resources for a cost-effective construction.
                    </li>
                  </ul>
                </div>
              </div>
              <div className="col-md-4">
                <div className="border-[1px] border-gray-300 rounded-md mt-10 md:mt-0">
                  ...
                  <div className="flex flex-col text-white gap-1">
                    ...
                    <div className="text-3xl md:text-xl xl:text-3xl">+919149159468</div>
                  </div>
                  </div>
                </div>
              </div>
...
export default ConstructionMng;
